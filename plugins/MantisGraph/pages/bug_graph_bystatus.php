...
//	$t_graph_font = graph_get_font();
	...
	$t_graph->options->font = 'fonts/arial.ttf' ;
...
function error_text( $p_title, $p_text ) {
	...
	$t_text_color = imagecolorallocate( $t_image, 255, 200, 200 );
	$t_text_color = imagecolorallocate( $t_image, 200, 0, 0 );
